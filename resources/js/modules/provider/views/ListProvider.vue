<template>
  <div class="card">
    <div class="card-header">
      <h3 class="mb-0">Lista de Provedores</h3>
    </div>
    <div class="card-body">
...
import FiltersForm from '../components/FiltersProvider.vue'
import TableList from '../components/TableProvider.vue'
